...
const SignInWithEmailPassword = ({emailSignInStart}) => { 
  ...
  const handleChange = event => {
    ...
    return (
      <SignInWithEmailPasswordDiv>
        <SignInWithEmailPasswordHeading>Already have an account?</SignInWithEmailPasswordHeading>
        ...
        <SignInTextDiv>Don't have an account? <SignUpLink to='/signup'>Sign-up</SignUpLink></SignInTextDiv>
      </SignInWithEmailPasswordDiv>
    );
}
...
export default connect(null, mapDispatchToProps)(SignInWithEmailPassword);
