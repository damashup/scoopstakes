...
const INTIAL_STATE = {currentUser: null, isFetching: false, error: null};
...
describe('userReducers - SIGN_IN_SUCCESS reducer', () => {
    ...
    const STATE2 = {currentUser: null, isFetching: true, error: null} 
    ...
    it('should handle SIGN_IN_SUCCESS action', () => {expect(userReducer(STATE1, ACTION1)).
        toEqual({currentUser: ACTION1.payload, isFetching: false, error: null})})

    it('should handle SIGN_IN_SUCCESS action (update fetching)', () => {expect(userReducer(STATE2, ACTION1))
        .toEqual({currentUser: {displayName: 'Nanzo'}, isFetching: false,error: null})})
})

describe('userReducers - SIGN_OUT_SUCCESS reducer', () => {
    const STATE1 = {currentUser: {displayName: 'Nanzo'}, isFetching: false, error: null}
    const STATE2 = {currentUser: {displayName: 'Nanzo'}, isFetching: true, error: null} 
    ...
    it('should handle SIGN_OUT_SUCCESS action (update fetching)', () => {expect(userReducer(STATE2, ACTION1))
        .toEqual({currentUser: null, isFetching: false,error: null})})
})
...
describe('userReducers - SIGN_IN_FAILURE reducer', () => {
    ...
    it('should handle SIGN_IN_FAILURE action', () => {expect(userReducer(STATE1, ACTION1)).
        toEqual({currentUser: STATE1.currentUser, isFetching: false, error: ACTION1.payload})})

    it('should handle SIGN_IN_FAILURE action (update fetching)', () => {expect(userReducer(STATE2, ACTION1))
        .toEqual({currentUser: STATE2.currentUser, isFetching: false, error: ACTION1.payload})})
})
